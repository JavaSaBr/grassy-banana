 ...
 */
package com.Stomrage.grassybanana.GrassFactory;

import com.Stomrage.grassybanana.GrassArea.GrassArea;
import com.Stomrage.grassybanana.Shared.GrassBlade;
...
public class GrassFactory {
    ...
    public void addDensityMap(Texture densityTexture) {
        this.densityTexturesImage.add(densityTexture.getImage());
     ...
     */
    public List<GrassBlade> createGrass(int minX, int minZ, int maxX, int maxZ, int x, int z) {
    ...
    public Material createMaterial() {
        Material grassMat = new Material(assetManager, "com/Stomrage/grassybanana/Material/grass.j3md");
     ...
     */
    public ArrayList<Image> getDensityTextures() {
        return densityTexturesImage;
    }
     ...
     */
    public void setDensityTextures(ArrayList<Image> densityTexturesImage) {
        this.densityTexturesImage = densityTexturesImage;
        for (Image i : densityTexturesImage) {            
            densityTextures.add(ImageRaster.create(i));
        }
    }
     ...
     */
    public void setLayerHash(HashMap<HashKey, Layer> layerHash) {
    ...
    public ArrayList<GrassBlade> updateHeight(ArrayList<GrassBlade> grassBlades) {
     ...
     */
    public void adjustHeight(int layer, int color, float[][] height, int size, Vector2f at, boolean adjust) {
    ...
    public void setLayerDensity(int densityMap, int colorChannel, float density) {
        layerHash.get(new HashKey(densityMap, colorChannel)).density = density;
    }

    public void setLayerTexture(int densityMap, int colorChannel, float minX, float size) {

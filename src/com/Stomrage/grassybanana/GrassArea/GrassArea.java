 ...
 */
package com.Stomrage.grassybanana.GrassArea;

import com.Stomrage.grassybanana.GrassFactory.GrassFactory;
import com.Stomrage.grassybanana.GrassFactory.GrassUtils;
import com.Stomrage.grassybanana.GrassFactory.HashKey;
import com.Stomrage.grassybanana.GrassFactory.Layer;
import com.Stomrage.grassybanana.GrassFactory.PerlinNoise;
...
public class GrassArea extends Geometry implements GrassObject {
     ...
     * Same as
     *
     * @see adjustDensity but this time the height is set to the 2d array in
     * parameter
     * @param densityMap The density map to change
     * @param colorChannel The color channel to modify
    ...
    public void readGrassFactory(JmeImporter im) throws IOException {
        ...
        ArrayList<Image> densityImage = capsule.readSavableArrayList("densityTextures", new ArrayList<Image>());
        ...
        GrassFactory.getInstance().setDensityTextures(densityImage);
    ...
    public void writeGrassFactory(JmeExporter ex) throws IOException {
        ...
        ArrayList<Image> densityTextures = GrassFactory.getInstance().getDensityTextures();
        ...
        capsule.writeSavableArrayList(densityTextures, "densityTextures", new ArrayList<Image>());

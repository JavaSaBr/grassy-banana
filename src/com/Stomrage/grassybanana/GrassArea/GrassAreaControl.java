...
public class GrassAreaControl implements Control {
    ...
    /**
     * The GrassAreaControl construct, only take the camera since the GrassArea
     * will be linked with the setSpatial control method
     *
     ...
     * with the level of subdivision, until a GrassHolder is found and then fill
     * the GrassBlades list in parameter
     *
